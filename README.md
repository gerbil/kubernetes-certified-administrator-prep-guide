...
- Install Kubernetes masters and nodes.
    ...
    - [Setup: Bootstrapping Clusters with kubeadm: Creating a single master cluster with kubeadm](https://kubernetes.io/docs/setup/independent/create-cluster-kubeadm/)
...
- Choose a network solution.
    ...
    - [Setup: Bootstrapping Clusters with kubeadm: Creating a single master cluster with kubeadm: #Installing a pod network add-on](https://kubernetes.io/docs/setup/independent/create-cluster-kubeadm/#pod-network)
...
- Understand Kubernetes cluster upgrade process.
    ...
    - [Tasks: Administration with kubeadm: Upgrading kubeadm clusters from v1.13 to v1.14](https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade-1-14/)
    - [Tasks: Administration with kubeadm: Upgrading kubeadm HA clusters from v1.12 to v1.13](https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade-ha-1-13/)
